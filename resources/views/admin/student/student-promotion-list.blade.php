...
<head>
    ...
    <title>Students Promotion List - Tech Web Mantra</title>
    ...
    <div id="wrapper" class="wrapper bg-ash">
        ...
        <div class="dashboard-page-one">
            ...
            <div class="breadcrumbs-area d-flex justify-content-between align-items-center flex-wrap">
                <div>
                    <h3>Students Promotion</h3>
                    <ul class="breadcrumb mb-0">
                        <li><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li>Students Promotion List</li>
                    </ul>
                </div>
                <div class="mt-2 mt-md-0">
                    <a href="{{ route('admin.student_promotion') }}" class="btn btn-primary btn-lg">
                        <i class="fas fa-plus-circle mr-2"></i> Create Students Promotion
                    </a>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#student_addmission_list').DataTable({
                ...
                pageLength: 10,
                ajax: {
                    url: "{{ route('admin.get_student_promotion_list') }}",
                    type: "POST",
