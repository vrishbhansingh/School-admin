...
<head>
    ...
    <title>Add Library Books - Tech Web Mantra</title>
                        ...
                        <form class="new-added-form">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Writter Name" class="form-control">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Class *</label>
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Publishing Date" class="form-control">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Uploade Date *</label>
                                    <input type="text" placeholder="Uploade Date" class="form-control">
                                </div>
