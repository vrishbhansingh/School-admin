            ...
            <div class="breadcrumbs-area d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="mt-2 mt-md-0">
                    <button type="button" class="modal-trigger" data-toggle="modal" data-target="#sign-up">
                        <i class="fas fa-plus-circle mr-2"></i> Add Fees Type
                    </button>
                </div>
            </div>
        ...
        <div class="modal-content">
            <form id="fee-setting-form" method="POST">
                ...
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title"><i class="fas fa-coins mr-2"></i> Add FeesTypes</h5>
                    <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="name">Name</label>
                        <input type="text" class="form-control" name="name" id="name" placeholder="Ex. Name">
                    </div>
                    <div class="form-group">
                        <label for="fees_code">Fees Code</label>
                        <input type="text" class="form-control" name="fees_code" id="fees_code" placeholder="Fees Code" readonly>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <p class="mb-0">Are you sure you want to delete this Fee Type?</p>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#confirm-delete-btn').on('click', function () {
            ...
            $.ajax({
                url: "{{ route('admin.delete_fee_type') }}",
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    id: id
