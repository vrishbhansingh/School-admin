...
<head>
    ...
    <title>Exam Classes - Tech Web Mantra</title>
            ...
            <div class="breadcrumbs-area d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="mt-2 mt-md-0">
                    <button type="button" class="modal-trigger" data-toggle="modal" data-target="#addClassModal">
                        <i class="fas fa-plus-circle mr-2"></i> Create Exam Classes
                    </button>
                </div>
            </div>
        ...
        <div class="modal-content">
            <form id="add_exam_form" method="POST">
                ...
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title"><i class="fas fa-plus-circle mr-2"></i> Create Exam Class</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="exam_id" id="exam_ids" >
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="class_id" id="class_ids" >
                ...
                <div class="modal-footer justify-content-center">
                    <button type="submit" id="submit_button" class="btn btn-primary btn-lg px-4">
                        <span id="btn_text">Save Exam Class</span>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="update_exam_form" method="POST">
                ...
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title"><i class="fas fa-plus-circle mr-2"></i> Update Exam Class</h5>
                    <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
                </div>
                <div class="modal-body">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
    ...
    $(document).ready(function () {
        ...
        let table = $('#get_exam').DataTable({
            ...
            responsive: true,
            ajax: {
                url: "{{ route('admin.get_exam_classes') }}",
                type: "POST",
        ...
        $('#add_exam_form').on('submit', function (e) {
            ...
            $.ajax({
                url: "{{ route('admin.save_exam_class') }}",
                type: "POST",
                data: fd,
                dataType: 'json',
                processData: false,
