...
<head>
    ...
    <title>Exam Schedule - Tech Web Mantra</title>
        ...
        <div class="modal-content">
            <form id="add_exam_form" method="POST">
                ...
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title"><i class="fas fa-plus-circle mr-2"></i> Create Exam</h5>
                    <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
                </div>
                <div class="modal-body">
                    
                    <div class="form-group">
                        <label for="class_name">Exam Session Year</label>
                        <select class="form-control" name="session_year" id="session_years" >
                            <option value=''>Select Exam Session Year</option>
                    ...
                    <div class="form-group">
                        <label for="class_name">Exam Name</label>
                        <input type="text" class="form-control" name="exam_name" id="exam_names" placeholder="Enter Exam Name">
                    </div>
                    
                    
                    <div class="form-group">
                        <label for="class_name">Start Date</label>
                        <input type="date" class="form-control" name="start_date" id="start_dates" placeholder="Enter Start Date">
                    </div>
                    
                    <div class="form-group">
                        <label for="class_name">End Date</label>
                        <input type="date" class="form-control" name="end_date" id="end_dates" placeholder="Enter End Date">
                    </div>
                </div>
                ...
                <div class="modal-footer justify-content-center">
                    <button type="submit" id="submit_button" class="btn btn-primary btn-lg px-4">
                        <span id="btn_text">Save Exam</span>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="update_exam_form" method="POST">
                @csrf
                <input type="hidden" name="id" id="exam_id" value="0">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title"><i class="fas fa-plus-circle mr-2"></i> Update Exam</h5>
                    <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="class_name">Exam Name</label>
                        <input type="text" class="form-control" name="exam_name" id="exam_name" placeholder="Enter Exam Name">
                    </div>
                ...
                <div class="modal-footer justify-content-center">
                    <button type="submit" id="submit_button" class="btn btn-primary btn-lg px-4">
                        <span id="btn_text">Update Exam</span>
                        <span id="btn_spinner" class="spinner-border spinner-border-sm d-none"></span>
                    </button>
                    <button type="button" class="btn btn-light btn-lg px-4 mr-3" data-dismiss="modal" style="border: 1px solid #ccc;">
                        <i class="fas fa-times mr-1"></i> Cancel
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <p class="mb-0">Are you sure you want to delete this Exam?</p>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#update_exam', function () {
            let id = $(this).data('id');
            let session_year = $(this).data('session_year');
