...
<head>
    ...
    <title>All Subjects - Tech Web Mantra</title>
        ...
        <div class="modal-content">
            <form id="add_subject_form" method="POST">
                ...
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title"><i class="fas fa-plus-circle mr-2"></i> Add Subject</h5>
                    <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="class_name">Subject Name</label>
                        <input type="text" class="form-control" name="name" id="subject_name" placeholder="Enter Subject Name">
                    </div>
                    
                    <div class="form-group">
                        <label for="class_name">Subject Code</label>
                ...
                <div class="modal-footer justify-content-center">
                    <button type="submit" id="submit_button" class="btn btn-primary btn-lg px-4">
                        <span id="btn_text">Save Subject</span>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#confirm-delete-btn').on('click', function () {
            ...
            $.ajax({
                url: "{{ route('admin.delete_subject') }}",
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    id: id
