        ...
        <div class="dashboard-content-one">
            ...
            <div class="breadcrumbs-area d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="mt-2 mt-md-0">
                    <button type="button" class="modal-trigger" data-toggle="modal" data-target="#addSectionModal">
                        <i class="fas fa-plus-circle mr-2"></i> Add New Section
                    </button>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table display data-table text-nowrap" id="get_section">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Class</th>
...
<!-- Add Section Modal -->
<div class="modal fade" id="addSectionModal" tabindex="-1" role="dialog" aria-labelledby="addSectionLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="add_section" method="POST">
                @csrf
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title"><i class="fas fa-plus-circle mr-2"></i> Add New Section</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Enter Section Name" class="form-control" name="name">
                    </div>
                </div>
                <div class="modal-footer justify-content-center">
                    <button type="submit" id="submit-button" class="btn btn-primary btn-lg px-4">
                        <span id="btn-text">Save Section</span>
...
<script>
    ...
    $(document).ready(function () {
        $('#class-dropdown').select2({ placeholder: 'Please Select Class *', allowClear: true, width: '100%' });

        $.ajaxSetup({
            headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') }
        });

        let table = $('#get_section').DataTable({
            processing: true,
            serverSide: true,
            pageLength: 10,
            responsive: true,
            ajax: {
                url: "{{ route('admin.get_section') }}",
                type: "POST",
        ...
        $('#confirm-delete-btn').on('click', function () {
            ...
            $.ajax({
                url: "{{ route('admin.delete_section') }}",
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    id: id
